...
def _prepare_vega_lite_spec(
    ...
    **kwargs: Any,
    ...
    if "autosize" not in spec:
        ...
        # on vconcat with width='stretch' as there are unintended
        ...
        use_container_width : bool or None
            ...
            .. deprecated::
               ``use_container_width`` is deprecated and will be removed in a
                future release. For ``width='stretch'``, use
                ``width="stretch"``.
        ...
        if use_container_width is not None:
            show_deprecation_warning(
                make_deprecated_name_warning(
                    ...
                    "width",
                    "2025-12-31",
                    "For `width='stretch'`, use `width='stretch'`. "
                    "For `width='content'`, use `width='content'` or specify an integer width.",
            ...
            if use_container_width:
                ...
                width = "content"
                # Otherwise keep the integer width - user explicitly set both width='content' and width=int
